...
Based on remote programming, video streaming feedback and a scenario around collaborative space rescue, R2T2 focus on pedagogic elements that are fundamentally different than classical robotic competitions. 
The value of this educational actions is shows through the results of a survey made among the participants. 
...
The contribution of this paper is to show an approach to implement a Noth-South collaboration to get school students excited about robotics and their problem-solving skills required in engineering. 
%limited to 190words
}
